...
namespace Data_Structures
{
    class Program
    {
        ...
        static double[] ArrayInDouble(int size)
        {
        ...
        static void ArrayOutDouble(double[] arr)
        {
        ...
        static int[] DoubleToInt(double[] arr)
        {
            int[] res = new int[arr.Length];
            for (int i = 0; i < arr.Length; i++)
                res[i] = Convert.ToInt32(arr[i] * 1000);
            return res;
        }

        static double[] IntToDouble(int[] arr)
        {
            double[] res = new double[arr.Length];
            for (int i = 0; i < arr.Length; i++)
                res[i] = Convert.ToDouble(arr[i]) / 1000;
            return res;
        }
