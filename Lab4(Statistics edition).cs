...
namespace Data_Structures
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int size = 300, search_method = 2, generate = 1,key;
            ...
            for (int j = 0;j<100 ;j++ )
            {
                ...
                //Choosing search method based on user input
                if (search_method == 1)
                {
                        int Sr, Pr;
            ...
            Console.WriteLine($"Compasrisons = {(double)results[0] / 100}\tAssignments = {(double)results[1] / 100}\t\tSum = {(double)results[2] / 100}");
            Console.WriteLine("Time : " + average.TotalMilliseconds/ 100);
        }
    }
}
